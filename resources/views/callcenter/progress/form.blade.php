    ...
    <div class="card" id="vue-progress">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="record_type_id" type="record_type_id"
                                            ...
                                            value="{{is_null(old('record_type_id')) ? $progress->record_type_id : old('record_type_id')}}" autofocus>
                                        <option value="">SELECIONE</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="area_id" type="area_id"
                                            ...
                                            value="{{is_null(old('area_id')) ? $progress->area_id : old('area_id')}}" autofocus>
                                        <option value="">SELECIONE</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="progress_type_id" type="progress_type_id"
                                            ...
                                            value="{{is_null(old('progress_type_id')) ? $progress->progress_type_id : old('progress_type_id')}}" autofocus>
                                        <option value="">SELECIONE</option>
                        ...
                        <textarea id="original"
                                  ...
                                  required rows="15">{{$progress->original}}</textarea>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <button v-on:click="changeFormRoute('{{route('progresses.store')}}')" class="btn btn-primary">
                                        {{ __('Gravar') }}
                                    </button>
                                    <button v-on:click="changeFormRoute('{{route('progresses.storeAndFinish')}}')" class="btn btn-primary">
