...
@section('content-main')
    <div class="page-name">
        <h1 class="nome-pagina mt-5">Alô Alerj</h1>
    </div>
    <h3 class="mt-5 mb-5">O Alô Alerj é o canal de comunicação entre o cidadão e a Assembléia Legislativa do Estado do Rio de Janeiro (Alerj).</h3>
    <div class="texto-pages mb-5 mt-4">
        ...
        <p>Nosso horário de atendimento é de <span class="text-secondary">2ª feira à 6ª feira de 10h às 17h. </span></p>
    </div>
@stop
