<nav class="navbar navbar-expand-xl navbar-light navbar-laravel">
    <a class="navbar-brand" href="{{ url('/callcenter') }}">
        <img class="aloalerj-logo-home"  src="/templates/mv/svg/logo-alo-alerj-callcenter.svg" alt="AloAlerj - Callcenter">
    </a>
        ...
        <ul class="navbar-nav ml-auto">
           @guest
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-nowrap" data-toggle="dropdown" id="dropdownMenuLink" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-archive" aria-hidden="true"></i>cadastros</a>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-nowrap" data-toggle="dropdown" role="button"
