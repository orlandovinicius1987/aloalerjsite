...
@section('content-main')
    ...
    <div class="row g-3 mb-5">
                ...
                <div id="vue-contact-form">
                    ...
                    <div class="row gy-3">
                        ...
                        {{--
                                            ...
                                            <div class="col-12">
                                                <label for="address2" class="form-label">Complemento do Endereço<span class="text-muted">(Opcional)</span></label>
                                                <input type="text" class="form-control" id="address2" placeholder="Apartamento or loja">
                                            </div>
        ...
        <div class="col-md-7 col-lg-10 offset-lg-1 mt-5">
            <h4 class="mb-3">
                Dados Pessoais
            </h4>
