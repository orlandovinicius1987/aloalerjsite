    ...
    methods: {
        ...
        showAccessCode(accessCode, route, has_email) {
            if (has_email) {
                return swal({
                    title:
                        'Enviar o código de acesso para os e-mails cadastrados do cidadão?',
                    icon: 'warning',
                    buttons: {
                        cancel: 'Cancelar',
                        confirm: 'Confirmar',
                    ...
                    if (response) {
                        ...
                        swal({
                            ...
                            dangerMode: false,
                            text:
                                'Código enviado para o(s) e-mail(s) cadastrado(s)',
                        })
                        // })
                    }
                })
                ...
                swal({
                    title:
                        'O usuário não possui e-mails válidos para envio da chave de acesso',
                    icon: 'warning',
                    buttons: {
                        confirm: 'OK',
                    },
