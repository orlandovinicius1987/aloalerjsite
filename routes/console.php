...
Artisan
    ::command('cercred:import', function () {
        app(ImportCercred::class)->import($this);
    })
    ->describe('Display an inspiring quote');

Artisan
    ::command('cercred:index', function () {
        ...
        Schema
            ::connection('cercred')
            ->table('historico_propriedade', function ($table) {
                $table->index('historico_id');
        ...
        Schema
            ::connection('cercred')
            ->table('historico_tipo', function ($table) {
                $table->index('historico_tipo');
            });

        Schema
            ::connection('cercred')
            ->table('action_historico', function ($table) {
                $table->index('historico_tipo');
            });
...
Artisan
    ::command('cercred:truncate-records', function () {
        Record::truncate();
        Progress::truncate();
    })
    ->describe('Display an inspiring quote');
